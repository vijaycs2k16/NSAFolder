...
public class AlbumSelectActivity extends HelperActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent imageSelectActivity = new Intent(getApplicationContext(), ImageSelectActivity.class);
                imageSelectActivity.putExtra(Constants.INTENT_EXTRA_ALBUM, albums.get(position).name);
                if(intent.hasExtra("AttachmentActivity")) {
                    imageSelectActivity.putExtra("From", "AttachmentActivity");
                } else {
                    imageSelectActivity.putExtra("From", "AlbumSelectActivity");
                }
                if (from.equals("SelectedImagesActivity")){
                    imageSelectActivity.putExtra("For callback", "SelectedImages");
                    startActivityForResult(imageSelectActivity, 115);
                } else
                    startActivityForResult(imageSelectActivity, Constants.REQUEST_CODE);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == Constants.REQUEST_CODE
            ...
            finish();
        } else if (requestCode ==115 && resultCode == RESULT_OK && data != null ) {
            //images = data.getParcelableArrayListExtra("addphoto");
