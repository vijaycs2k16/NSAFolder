...
public class SampleMessageGenerator {
	...
	private static Map<String, String> getMyData(int roomNo) {

		Map<String, String> payload = new HashMap<String, String>();
		payload.put("message", String.valueOf(roomNo));
		return payload;
	}
	...
	public static String videoCallSampleMessage(int roomNo){

		Map<String, Object> androidMessageMap = new HashMap<String, Object>();
		androidMessageMap.put("collapse_key", "Welcome");
		androidMessageMap.put("data", getMyData(roomNo));
		androidMessageMap.put("delay_while_idle", true);
		androidMessageMap.put("time_to_live", 125);
		androidMessageMap.put("dry_run", false);
		return jsonify(androidMessageMap);
