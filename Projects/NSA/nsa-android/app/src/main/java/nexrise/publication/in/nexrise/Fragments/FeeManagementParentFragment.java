 ...
 * {@link FeeManagementParentFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FeeManagementParentFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FeeManagementParentFragment extends Fragment implements Constants{
    ...
    public FeeManagementParentFragment() {
     ...
     * @return A new instance of fragment FeeManagementParentFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static FeeManagementParentFragment newInstance(String param1, String param2) {
        FeeManagementParentFragment fragment = new FeeManagementParentFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        studyValue.setText(R.string.fee_management);
        name.setText(firstName);
        icon.setImageResource(R.drawable.ic_fee);
        icon.setColorFilter(getResources().getColor(R.color.appColor));
        parentFeeActivity(view);
    ...
    private void parentFeeActivity(View view) {
        LinearLayout student = (LinearLayout) view.findViewById(R.id.student_info);

        student.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent parentFeeFragment = new Intent(getActivity(), FeeManagementParentActivity.class);
                getActivity().startActivity(parentFeeFragment);
            }
        });
    }
...
/*ActionBar actionBar = getSupportActionBar();
        if(actionBar!= null){
            ...
            actionBar.setTitle("Fee Management");
