...
import nexrise.publication.in.nexrise.Gallery.CreateAlbumActivity;
import nexrise.publication.in.nexrise.Gallery.CustomGallery.ArrayAdapter.CustomAlbumSelectAdapter;
...
public class AlbumSelectFragment extends HelperFragment {
    ...
    private final int CREATE_ALBUM_ACTIVITY = 25;
     ...
     * @return A new instance of fragment AlbumSelectFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static AlbumSelectFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(getActivity().getApplicationContext(), ImageSelectActivity.class);
                intent.putExtra(Constants.INTENT_EXTRA_ALBUM, albums.get(position).name);
                intent.putExtra("From","AlbumSelectFragment");
                intent.putExtra("AlbumTitle",albums.get(position).name);
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    ...
                    case Constants.FETCH_COMPLETED: {
                        ...
                        if (adapter == null) {
                            adapter = new CustomAlbumSelectAdapter(getActivity().getApplicationContext(), albums);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if(requestCode == CREATE_ALBUM_ACTIVITY && resultCode == RESULT_OK) {
    ...
    private void loadAlbums() {
        startThread(new AlbumSelectFragment.AlbumLoaderRunnable());
    }
        ...
        public void run() {
            ...
            Cursor cursor = getActivity().getApplicationContext().getContentResolver()
                    .query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, projection,
                            MediaStore.Images.Thumbnails.DATA+" like ?", new String[]{"%/"+"NexSchoolApp/Images"+"/%"}, null);
