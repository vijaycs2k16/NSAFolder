package org.publication.in.nexrise;
...
public interface Constants {
    ...
    String ID = "id";
    String ACCESS_ID = "32aaa410-51d4-11e7-8dc1-3b9c08d048b3";
    Double LATITUDE = 10.487960;
    Double LONGITUDE = 77.946399;
    String SCHOOL_NAME = "ST.PATRICK'S ACADEMY Hr.Sec.School";
    ...
    //URLS
    String CHAT_SERVER_URL =  "http://192.168.0.108:5000/";

    String BASE_URL = "http://nexschoolapp.com:3333";
    ...
    //CCAvenue
    final String PARAMETER_SEP = "&";
    final String PARAMETER_EQUALS = "=";
    final String TRANS_URL = "http://test.ccavenue.com/transaction/initTrans";

    final String COMMAND = "command";
    final String WORKING_KEY = "working_key";
    final String ACCESS_CODE = "access_code";
    final String MERCHANT_ID = "merchant_id";
    final String ORDER_ID = "order_id";
    final String AMOUNT = "amount";
    final String CURRENCY = "currency";
    final String ENC_VAL = "enc_val";
    final String REDIRECT_URL = "redirect_url";
    final String CANCEL_URL = "cancel_url";
    final String RSA_KEY_URL = "http://test.ccavenue.com/transaction/getRSAKey";
    final String JSON_URL = "http://test.ccavenue.com/transaction/transaction.do";
    ...
    String SERVER_APIKEY = "AAAAYvI8lf8:APA91bEbXH_U-KFnH7jqW53Oyslo6eX5V_pJLpywQiDGkkle81yg8WTtBGznaXOTBi7djeArNtQ3MMZDaBU0hDWOUkNuJpflX4MULFM1y-tETsCffs4A_YzQaZjKvQXhGJsDjGfOXJsB";
    ...
    final String EVENTS_FEATURE_ID = "213ec4a2-1b04-4894-9098-d4e7f079961c";

    //File storage path
    final String IMAGES_PATH = "Image path";
    final String DOCUMENTS_PATH = "Document path";
    final String VIDEO_PATH = "Video path";
