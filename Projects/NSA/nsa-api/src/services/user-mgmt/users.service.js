...
const client = new cassandra.Client({ contactPoints: ['127.0.0.1'], keyspace: 'nsa' });

exports.getAllUsers = function(req, res) {
    var headers = baseService.getHeaders(req);
    var userId = req.params.id;
    console.info('headers.tenant_id = ', headers.tenant_id);
    ...
    models.instance.User.eachRow({tenant_id: models.timeuuidFromString(headers.tenant_id),
        ...
        if(result) {
            ...
            var params =
            [models.timeuuidFromString(headers.tenant_id), models.uuidFromString(headers.school_id)];
            ...
            console.info('nextPage = ', result.nextPage);
            if (result.nextPage) {
            ...
            console.info('result = ', result);
            console.info('pageState = ', requestParam.pageNo);
