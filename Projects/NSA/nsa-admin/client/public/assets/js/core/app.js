...
function enableAppJs() {
    $(function() {
        ...
        function containerHeight() {
            ...
            /*below line commented by senthil P. below line increase the container height */
        ...
        /*$('.menu-list li a:not(.dd-parent-a)').on('click', function (e) {
            $(this).parent().removeClass('open');
            $(this).parent('li').removeClass('open');
            if ($('li.mega-menu-wide').hasClass('open') ) {
                //e.preventDefault();
                $(this).parent('li').removeClass('open');
                $('li.mega-menu-wide').removeClass('open')
            }
        });*/
        ...
        $('.menu-list li a:not(.dd-parent-a)').on('click', function (e) {
            if ($('li.mega-menu-wide').hasClass('open') ) {
                ...
                //$(this).parent('li').hasClass('mega-menu-wide').removeClass('open');
        });
