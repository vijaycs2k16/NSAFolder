...
export class AllNotificationComponent implements OnInit {
    ...
    @ViewChild(GroupNotificationComponent) GroupNotificationComponent: GroupNotificationComponent;
    ...
    openOverlay(event: any) {
        ...
        this.GroupNotificationComponent.resetForm();
    }
  ...
  //  }
    ...
    saveNotification(id:any) {
        ...
        if (this.templateForm.valid) {
            ...
            if ((this.templateForm._value.classes.length == [ ] && this.templateForm._value.notifyTo.userType.length == [  ]) && !this.templateForm._value.phoneNo && this.templateForm._value.students == null ) {
                ...
                this.templateForm._value.type = 'General'
    ...
    getNotificationById(event:any, overlay: any) {
        ...
        if(value.type != 'undefined') {
            ...
            this.tab = value.type == 'Group' ? true : false;
        }
    ...
    callBackNotification(event: any, res:any, overlay:any) {
        if(res[0].type != 'Group') {
            ...
            //this.tabChange('Group');
            this.tab = true;
            this.GroupNotificationComponent.getNotificationById(event, res, overlay)
            this.getMediaCount();
        }
    }
