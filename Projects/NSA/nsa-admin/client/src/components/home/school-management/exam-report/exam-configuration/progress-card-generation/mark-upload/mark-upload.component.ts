...
export class MarkUploadComponent implements OnInit {
    ...
    @ViewChild(StudentPerformanceComponent) studentPerformanceComponent: StudentPerformanceComponent;
    ...
    ngOnInit() {
        this.btnEnable = this.baseService.haveBtnPermissions(this.constants.STUDENT_PERFORMANCE_PERMISSIONS, 'btn');
    ...
    viewStudentPerformance(event: any) {
        this.studentPerformanceComponent.show(event)
    }
