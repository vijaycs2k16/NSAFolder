            ...
            <div class="text-info">
              ...
              <div class="btn-group">
                ...
                <ul class="dropdown-menu" role="menu" aria-labelledby="current-version">
                  ...
                  <li><a href="../../1.1/features/execution-profiles/">1.1</a></li>
                
                  <li><a href="../../1.0/features/execution-profiles/">1.0</a></li>
...
<pre class="highlight"><code><span class="nx">client</span><span class="p">.</span><span class="nx">execute</span><span class="p">(</span><span class="nx">query</span><span class="p">,</span> <span class="nx">params</span><span class="p">,</span> <span class="p">{</span> <span class="na">executionProfile</span><span class="p">:</span> <span class="s1">'aggregation'</span> <span class="p">});</span>
</code></pre>
...
<pre class="highlight"><code><span class="nx">client</span><span class="p">.</span><span class="nx">execute</span><span class="p">(</span><span class="nx">query</span><span class="p">,</span> <span class="nx">params</span><span class="p">,</span> <span class="p">{</span> <span class="na">executionProfile</span><span class="p">:</span> <span class="nx">aggregationProfile</span> <span class="p">});</span>
</code></pre>
...
<pre class="highlight"><code><span class="nx">client</span><span class="p">.</span><span class="nx">execute</span><span class="p">(</span><span class="nx">query</span><span class="p">,</span> <span class="nx">params</span><span class="p">,</span> <span class="kc">null</span><span class="p">);</span>
</code></pre>
