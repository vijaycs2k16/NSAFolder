            ...
            <div class="text-info">
              ...
              <div class="btn-group">
                ...
                <ul class="dropdown-menu" role="menu" aria-labelledby="current-version">
                  ...
                  <li><a href="../1.1/getting-started/">1.1</a></li>
...
<p>All CQL features in the Cassandra driver (see the <a href="http://docs.datastax.com/en/developer/nodejs-driver/latest/features/">core driver features</a>) are available in the
DSE driver.</p>
...
<p>See <a href="http://docs.datastax.com/en/developer/nodejs-driver/latest/getting-started/">Getting started with DataStax Node.js driver for more information</a>.</p>
...
<pre class="highlight"><code><span class="kr">const</span> <span class="nx">client</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">dse</span><span class="p">.</span><span class="nx">Client</span><span class="p">({</span> 
  ...
  <span class="na">profiles</span><span class="p">:</span> <span class="p">[</span>
    <span class="k">new</span> <span class="nx">ExecutionProfile</span><span class="p">(</span><span class="s1">'time-series'</span><span class="p">,</span> <span class="p">{</span>
      <span class="na">consistency</span><span class="p">:</span> <span class="nx">consistency</span><span class="p">.</span><span class="nx">localOne</span><span class="p">,</span>
...
<span class="nx">client</span><span class="p">.</span><span class="nx">execute</span><span class="p">(</span><span class="s1">'SELECT * FROM system.local'</span><span class="p">,</span> <span class="kc">null</span><span class="p">,</span> <span class="p">{</span> <span class="na">executionProfile</span><span class="p">:</span> <span class="s1">'time-series'</span> <span class="p">});</span>

<span class="c1">// Use an execution profile for a gremlin query</span>
<span class="nx">client</span><span class="p">.</span><span class="nx">executeGraph</span><span class="p">(</span><span class="s1">'g.V().count()'</span><span class="p">,</span> <span class="kc">null</span><span class="p">,</span> <span class="p">{</span> <span class="na">executionProfile</span><span class="p">:</span> <span class="s1">'graph'</span> <span class="p">});</span>
</code></pre>
