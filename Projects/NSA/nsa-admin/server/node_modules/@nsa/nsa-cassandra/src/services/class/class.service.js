...
Classes.getClassByClasses = function(req, callback) {
    var headers = baseService.getHeaders(req);
    if(req.body.classes && !_.isEmpty(req.body.classes)) {
        var findQuery = {tenant_id: models.timeuuidFromString(headers.tenant_id),
            school_id: models.uuidFromString(headers.school_id),
            class_id: {$in : req.body.classes.map(i => models.uuidFromString(i))},
            academic_year: headers.academic_year};
        models.instance.SchoolClassDetails.find(findQuery, function(err, result){
