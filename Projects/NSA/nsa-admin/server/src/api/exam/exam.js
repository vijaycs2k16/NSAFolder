...
router.get('/schedule/details/:classId/:sectionId', examType.getExamScheduleByClassAndSec);
router.get('/schedule/terms/:classId/:sectionId', examType.getExamTermsByClassAndSec);//get scheduled exam details by class and section for marks upload filter
