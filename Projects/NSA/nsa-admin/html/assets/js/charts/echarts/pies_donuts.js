...
$(function () {
    ...
    require(
        ...
        function (ec, limitless) {
            ...
            var basic_donut;
            var nested_pie;
            var infographic_donut;
            var rose_diagram_hidden;
            var rose_diagram_visible;
            var lasagna_donut;
            var pie_timeline;
            var multiple_donuts;

            if (document.getElementById('basic_pie')) {
               basic_pie = ec.init(document.getElementById('basic_pie'), limitless);
            }

            if (document.getElementById('basic_donut')) {
                basic_donut = ec.init(document.getElementById('basic_donut'), limitless);
            }

            if (document.getElementById('nested_pie')) {
                nested_pie = ec.init(document.getElementById('nested_pie'), limitless);
            }

            if (document.getElementById('infographic_donut')) {
                infographic_donut = ec.init(document.getElementById('infographic_donut'), limitless);
            }

            if (document.getElementById('rose_diagram_hidden')) {
                rose_diagram_hidden = ec.init(document.getElementById('rose_diagram_hidden'), limitless);
            }

            if (document.getElementById('rose_diagram_visible')) {
                rose_diagram_visible = ec.init(document.getElementById('rose_diagram_visible'), limitless);
            }

            if (document.getElementById('lasagna_donut')) {
                lasagna_donut = ec.init(document.getElementById('lasagna_donut'), limitless);
            }

            if (document.getElementById('lasagna_donut')) {
                lasagna_donut = ec.init(document.getElementById('pie_timeline'), limitless);
            }

            if (document.getElementById('multiple_donuts')) {
                multiple_donuts = ec.init(document.getElementById('multiple_donuts'), limitless);
            }
            ...
            infographic_donut_options = {
                ...
                // Add title
                title: {
                    text: 'How presence are you?',
                    subtext: 'Academic Year 2017-2018',
                    x: 'center',
                    y: 'center',
                    itemGap: 10,
                    textStyle: {
                ...
                legend: {
                    ...
                    x: '55%',
                    itemGap: 15,
                    data: ['60% Present','30% Leave','10% Absence']
                },
