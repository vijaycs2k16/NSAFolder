...
import {GroupNotificationComponent} from "./all-notification/group-notification/group-notification.component";
...
@NgModule({
    ...
    exports: [],
    declarations: [NotificationComponent, MyNotificationComponent, AllNotificationComponent, GroupNotificationComponent],
})
