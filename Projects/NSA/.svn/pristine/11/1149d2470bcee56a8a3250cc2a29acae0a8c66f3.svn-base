define([
    ...
    var CreateView = ParentView.extend({
        ...
        saveItem: function () {
            ...
            var workPhones1= $thisEl.find('#phone').val();
            var workPhones2= $thisEl.find('#mobile').val();

            if (!workPhones2) {
                return App.render({
                    type: 'error',
                    message: "Personal Phone should't be empty."
                });
            }
            ...
            if (!personalEmail) {
                return App.render({
                    type: 'error',
                    message: "Personal Email should't be empty."
                });
            }
            ...
            if (!workEmail) {
                return App.render({
                    type: 'error',
                    message: "Work Email should't be empty."
                });
            }
            ...
            if (!workPhones1) {
                return App.render({
                    type: 'error',
                    message: "Work Phone should't be empty."
                });
            }
