define([
    ...
    'text!templates/course/list/cancelEdit.html',
    'text!templates/course/list/ListHeader.html',
    'text!templates/course/list/ListTemplate.html',
    'views/course/list/ListItemView',
    'views/course/CreateView',
    'models/JournalModel',
    'collections/course/filterCollection',
    'collections/course/editCollection',
    'dataService',
    'async'
