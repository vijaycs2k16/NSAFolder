define([], function () {
    return {
        ...
        URLS: {
            ...
            BUNDLEMOVE                 : '/products/bundleMove/',
            ...
            ASSIGNEES_PERSONSFORDD     : '/employees/getAssignees',
            DEALTASKS_TYPES            : '/dealTasks/types',
            CUSTOMERS                  : '/customers/',
            ...
            ASSIGN_VIEW                : '/leads/bulk/assign',
            LEADSNOTIFICATIONS         : '/leads/send/media'
        },
