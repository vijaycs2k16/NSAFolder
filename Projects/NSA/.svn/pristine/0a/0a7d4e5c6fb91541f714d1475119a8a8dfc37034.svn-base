define([
    ...
    var EditView = ParentView.extend({
                    ...
                    populate.fetchWorkflow({
                        ...
                        if (products && products.length) {
                            self.currentModel.save({
                                ...
                                patch  : true,
                                success: function () {
                                    var redirectUrl = self.forSales ? 'erp/salesOrders' : 'erp/Orders';
        ...
        createProforma: function (e) {
            ...
            var redirectUrl = self.forSales ? 'erp/salesProforma/list' : 'erp/Proforma/list';
            ...
            if (supplier) {
                this.model.save(data, {
                    ...
                    success: function (res) {
                        //if (url === '#erp/salesQuotations/list') {
                        //    self.hideDialog();
                        //    Backbone.history.fragment = '';
