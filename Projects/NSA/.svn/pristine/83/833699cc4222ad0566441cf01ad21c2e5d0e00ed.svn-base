define([
    ...
    'text!templates/VPracticeExam/EditTemplate.html',
    ...
    var createView = Parent.extend({
        ...
        selectCourse: function(cId){
            ...
            if (cId !== '') {
                dataService.getData('/vsubject/course', {category: 'SUBJECTS', courseId: cId, paper: true}, function (subjects) {
                    var subjectDats = []
        ...
        saveItem: function () {
            ...
            dataService.putData('/vpractice/exam/schedule/'+ this.currentModel.toJSON()._id, this.data, function (err, result) {
                if(err) {
                    return App.render({
                        type: 'error',
                        message: 'Error'
        ...
        render: function () {
            ...
            populate.get('#course', '/vCourse/', {}, 'courseName', this, true);
