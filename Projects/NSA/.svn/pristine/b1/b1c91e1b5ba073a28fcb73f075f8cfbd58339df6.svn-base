    ...
    var FormProductView = ParentView.extend({
        ...
        saveSKUs: function (e) {
            ...
            dataService.postData(url, {skus: arrayOfDifferent}, function (result) {
                Backbone.history.fragment = '';
                Backbone.history.navigate('erp/Products/list', {trigger: true});
            });
        },
        ...
        render: function (element) {
            ...
            parallelTasks = {
                availabilities: function (pCb) {
                    dataService.getData('/products/stockInventoryDetails/' + currentProductId, {}, function (availabilities) {
        ...
        deleteItems: function () {
            ...
            this.editModel.destroy({
                ...
                success: function () {
                    Backbone.history.navigate('#erp/Products/thumbnails', {trigger: true});
                }
            });
        }
