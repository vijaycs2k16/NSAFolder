define([
    ...
    'text!templates/schoolOnboard/EditTemplate.html',
    ...
    'dataService',
    'Lodash'
], function (Backbone, $, _, Parent, EditTemplate, CenterCourseItems, CenterCourseItem, SelectView, populate, CONSTANTS, keyValidator, helpers, dataService, lodash) {
    'use strict';
    ...
    var EditView = Parent.extend({
        ...
        getProducts: function (e) {
            ...
            this.$el.find('#productList').append(_.template(CenterCourseItem, {model: {}, termObj : terms}));
        },
        ...
        renderTitle: function(id) {
            ...
            dataService.getData('/franchise/getForCenter', {center: id}, function (data) {
                self.$el.find('#productItemsHolder').html(_.template(CenterCourseItems, {model: data.data, termObj : terms}));
            });
        },
        ...
        render: function () {
            ...
            dataService.getData('/title/schoolTitle', {}, function (titles) {
                ...
                self.responseObj['#schoolId'] = titles;
            });
