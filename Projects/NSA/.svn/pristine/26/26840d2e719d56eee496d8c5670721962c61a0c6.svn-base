...
module.exports = function (event, models) {
     ...
     * */
    router.get('/taxanomy', handler.getEmpTaxanomy);
    router.get('/leave/reports', handler.getEmpLeaveReport);
    router.get('/taxanomy/:id', handler.getUpdateEmpTaxanomyDetails);
    ...
    router.get('/getAssignees', handler.getAssignees);
