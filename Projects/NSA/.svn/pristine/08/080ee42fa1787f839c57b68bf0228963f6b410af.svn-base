module.exports = (function () {
    ...
    var employeeSchema = new mongoose.Schema({
        ...
        workEmail    : {type: String, default: '', unique: true, dropDups: true},
        personalEmail: {type: String, default: '', unique: true, dropDups: true},

        workPhones: {
            mobile: {type: String, default: '', unique: true, dropDups: true},
            phone : {type: String, default: '', unique: true, dropDups: true}
        },
