...
var express = require('express'),
    ...
    assignment = require('../../services/assignmentLog/assignments.service.js');
module.exports = function (models) {
    var assigments = new assignment(models)
     ...
     router.put('/details/status/:id', assignments.updateAssignmentDetailsStatus); //status update
