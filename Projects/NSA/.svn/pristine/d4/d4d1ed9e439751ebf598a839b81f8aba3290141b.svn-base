define([
    ...
    var appRouter = Backbone.Router.extend({
        ...
        routes: {
            home: 'any',
            //nsa extra urls start
            'erp/VCourses': 'goToVCourses',
            'erp/VBatches(?schedule=:schedule)': 'goToVBatches',
            'erp/Academics/Attendance': 'academicAttendance',
            'erp/VNotifications': 'goToVNotifications',
            'erp/registrationForm/:ID': 'registrationForm',
            'erp/print/:ID': 'registrationPrintForm',
            'erp/exam/print/:ID': 'examPrintForm',
            'erp/config/print/:ID': 'configPrintForm',
            'erp/VQuestionBank/new': 'questionBankForm',
            'erp/VExamResult/:id': 'examResultForm',
            'erp/VExamStudentsResult/:id': 'examStudentsResult',
            'erp/VExam(?paper=:paper)': 'goToVExam',
            'erp/examForm/:ID': 'examPaper',
            'erp/customDashboardCharts' : 'goToCustomDashboardCharts',
            'erp/assesmentDashboard' : 'goToAssDashboardCharts',
            'erp/studentDashboardCharts/:id/:cid/:center/:bid' : 'goToStudentDashboardCharts',
            //nsa extra urls end

            'erp/Products/thumbnails(/c=:countPerPage)(/filter=:filter)': 'goToProduct',
            'erp/import/list(/p=:page)(/c=:countPerPage)': 'goToImport',
            'login(?password=:password&dbId=:dbId&email=:email)(?ir_hash=:ir_hash)': 'login',
            'erp/gatherInfo': 'goToGatherInfo',
            'erp/:contentType/kanban(/:parrentContentId)(/filter=:filter)': 'goToKanban',
            'erp/:contentType/datelist(/p=:page)(/c=:countPerPage)(/filter=:filter)': 'goToDateList',
            'erp/:contentType/thumbnails(/c=:countPerPage)(/filter=:filter)': 'goToThumbnails',
            'erp/:contentType/tform(/:modelId)(/p=:page)(/c=:countPerPage)(/filter=:filter)': 'goToTForm', // FixMe chenge to required Id after test
            'erp/:contentType/form(/:modelId)': 'goToForm', // FixMe chenge to required Id after test
            'erp/:contentType/list(/pId=:parrentContentId)(/p=:page)(/c=:countPerPage)(/filter=:filter)': 'goToList',
            'erp/Revenue(/filter=:filter)': 'revenue',
            'erp/settingsEmployee(/filter=:filter)': 'settingsEmployee',
            'erp/Efficiency': 'hours',
            'erp/Attendance': 'attendance',
            'erp/VAttendance': 'academicAttendance',
            'erp/Profiles': 'goToProfiles',
            'erp/organizationSettings': 'organizationSettings',
            'erp/myProfile': 'goToUserPages',
            'erp/Workflows': 'goToWorkflows',
            'erp/Accounts(/:type)': 'goToAccounts',
            'erp/productsSettings': 'goToProductSettings',
            'erp/centerSettings': 'goToCenterSettings',
            'erp/settingsOverview': 'goToSettingsOverview',
            'erp/reports(/:modelId)': 'goToReports',
            //'erp/productsReports'                                                                     : 'goToProductsReports',
            'erp/inventoryReports': 'goToInventoryReports',
            'erp/salesReports': 'goToSalesReports',
            'erp/integrations(/:type)(/syncLog/:id)': 'goToIntegrations',
            'erp/resolveConflicts': 'resolveConflicts',
            'erp/unlinkedProducts(/filter=:filter)(?fromIntegration=:fromIntegration)': 'unlinkedProducts',
            'erp/Dashboard': 'goToDashboard',
            'erp/reportsDashboard': 'goToMarketingCharts',
            'erp/taskDashboard': 'goToTaskDashboard',
            'erp/dashboards': 'goToDashboards',
            'erp/purchaseDashboard': 'goToCustomPurchaseDashboard',
            'erp/payrollDashboard': 'goToPayrollDashboard',
            'erp/DashBoardVacation(/filter=:filter)': 'dashBoardVacation',
            'erp/invoiceCharts(/filter=:filter)': 'invoiceCharts',
            'erp/HrDashboard': 'hrDashboard',
            'erp/projectDashboard': 'goToProjectDashboard',
            'erp/customDashboardCharts/:modelId': 'goToCustomDashboard',
            //'erp/warehouseMovements'                                                                  : 'goToWarehouseMovements',
            // 'erp/billOfMaterials'                                                                    : 'goToBillOfMaterials',
            'erp/:contentType': 'getList',
            '*any': 'any',
        },
        ...
        goToCustomDashboardCharts: function () {
            var self = this;
            var currentUser = App.currentUser || {};
            var modelId = '';
            var contentType = 'customDashboardCharts';
            if(currentUser.centerId == null && !currentUser.student) {
                modelId = '5a8adb3a2a25883c68a644ac'
            } else if(currentUser.profile.id == 1524552351000) {
                modelId = '5ae1672279b950aec3a198bd';
            } else if(currentUser.student) {
                modelId = '5a8d58d878f2b46954e28a63';
            } else if(currentUser.student) {
                modelId = '5a8d58d878f2b46954e28a63';
            } else if(currentUser.student) {
                modelId = '5a8d58d878f2b46954e28a63';
            } else {
                modelId = '5a90e4a84b09277e15edffb7'
            }
        ...
        goToAssDashboardCharts: function () {
            var self = this;
            var currentUser = App.currentUser || {};
            var modelId = '';
            var contentType = 'customDashboardCharts';
                modelId = '5baf912ba20fbf1fa00ed2b9';
        ...
        goToStudentDashboardCharts: function (id, cid, center, bid ) {
            var self = this;
            var currentUser = App.currentUser || {};
            App.userName = {id: id, cid: cid, bid: bid, center: center};
            var contentType = 'customDashboardCharts';
            var modelId = '5a8d58d878f2b46954e28a63';
        ...
        goToMarketingCharts: function () {
            var self = this;
            var currentUser = App.currentUser || {};
            var modelId = '';
            var contentType = 'customDashboardCharts';
            if(currentUser.profile) {
                if(currentUser.profile._id == 1524553140000 || currentUser.profile._id == 1387275598000 || currentUser.profile._id == 1527682829000) {
                    modelId = '5ae07b5243f1c487f4a75cf6';
                } else if(currentUser.profile._id == 1524552351000) {
                    modelId = '5ae1672279b950aec3a198bd';
                } else if(currentUser.profile._id == 1524552625000 || currentUser.profile._id == 1522230115000) {
                    modelId = '5ae1585ee297ecabfd3f1e03';
                } else if(currentUser.profile._id === 1524552846000 || currentUser.profile._id === 1524552941000 || currentUser.profile._id === 1524553113000) {
                    modelId =  '5af14eabcd4dcf249c9f147b';
                } else {
                    modelId = '5a90e4a84b09277e15edffb7'
                }

            } else {
                common.getCurrentuser(function (data) {
                    if (data) {
                        if(data.profile._id == 1524553140000) {
                            modelId = '5ae07b5243f1c487f4a75cf6';
                        } else if(data.profile._id == 1524552351000) {
                            modelId = '5ae1672279b950aec3a198bd';
                        } else if(data.profile._id == 1524552625000 || data.profile._id == 1522230115000) {
                            modelId = '5ae1585ee297ecabfd3f1e03';
                        } else if(data.profile._id === 1524552846000 || data.profile._id === 1524552941000 || data.profile._id === 1524553113000) {
                            modelId =  '5af14eabcd4dcf249c9f147b';
                        }  else {
                            modelId = '5a90e4a84b09277e15edffb7'
                        }
        ...
        goToTaskDashboard: function () {
            var self = this;
            var modelId = '5af447e3561a8f37341a1964';
            var contentType = 'taskDashboard';
        ...
        academicAttendance: function () {
            ...
            function renderAttendance(context) {
                var contentViewUrl = 'views/VAttendance/index';
                var topBarViewUrl = 'views/VAttendance/TopBarView';
                var self = context;
                ...
                if (context.mainView === null) {
                    context.main('VAttendance');
                    context.mainView.on('rendered', renderView);
                } else {
                    context.mainView.updateMenu('VAttendance');
                    renderView();
                }
            ...
            function goProfile(context) {
                ...
                require([contentViewUrl, topBarViewUrl, collectionUrl], function (contentView, topBarView, contentCollection) {
                    ...
                    function createViews() {
                        ...
                        topbarView.bind('PrintEvent', contentview.exportItem, contentview);
        ...
        examPaper: function(id){
            ...
            function startExam(context) {
                var startTime = new Date();
                var contentViewUrl = 'views/VExamSchedule/ExamPaper';
                var collectionUrl = context.buildCollectionRoute('VExamSchedule');
                var self = context;

                function renderView() {
                    return require([contentViewUrl, collectionUrl], function (ContentView, Collection) {
                        var collection = new Collection({reset: true});

                        collection.bind('reset', _.bind(createViews, self));

                        function createViews(collection) {
                            var contentView = new ContentView({collection: collection, modelId: id});
                ...
                if (context.mainView === null) {
                    context.main('ExamPaper');
                    context.mainView.on('rendered', renderView);
                } else {
                    context.mainView.updateMenu('ExamPaper');
                    renderView();
                }
            }
        ...
        registrationForm: function (id) {
            ...
            function registration(context) {
                var startTime = new Date();
                var contentViewUrl = 'views/EnrollMent/Registration/ContentView';
                var topBarViewUrl = 'views/EnrollMent/Registration/TopBarView';
                var self = context;
                ...
                if (context.mainView === null) {
                    context.main('EnrollMent');
                    context.mainView.on('rendered', renderView);
                } else {
                    context.mainView.updateMenu('EnrollMent');
                    renderView();
                }
            }

            function editRegister(context) {
                var startTime = new Date();
                var contentViewUrl = 'views/EnrollMent/Registration/EditView';
                var collectionUrl = 'collections/EnrollMent/editCollection';
                var self = context;

                function renderView() {
                    return require([contentViewUrl, collectionUrl], function (ContentView, Collection) {
                        var collection = new Collection({reset: true, count: 100000, id: id, filter: {}});
        ...
        registrationPrintForm: function (id) {
            var self = this;
            var currentUser = App.currentUser || {};
            ...
            function editRegister(context) {
                var startTime = new Date();
                var contentViewUrl = 'views/EnrollMent/Registration/PrintView';
                var collectionUrl = 'collections/EnrollMent/editCollection';
                var self = context;

                function renderView() {
                    return require([contentViewUrl, collectionUrl], function (ContentView, Collection) {
                        var collection = new Collection({reset: true, count: 100000, id: id});
        ...
        examPrintForm: function (id) {
            var self = this;
            var currentUser = App.currentUser || {};

            // FlurryAgent.logEvent('Organization Profile');

            function examPrint(context) {
                var startTime = new Date();
                var contentViewUrl = 'views/VExam/PrintView';
                var collectionUrl = context.buildCollectionRoute('VPaperConfig');
                var self = context;
                ...
                if (context.mainView === null) {
                    context.main('VExamSchedule');
                    context.mainView.on('rendered', renderView);
                } else {
                    context.mainView.updateMenu('VExamSchedule');
                    renderView();
                }
            }
        ...
        configPrintForm: function (id) {
            ...
            function examPrint(context) {
                var startTime = new Date();
                var contentViewUrl = 'views/testConfiguration/PrintView';
                var collectionUrl = context.buildCollectionRoute('testConfiguration');
                var self = context;
                ...
                if (context.mainView === null) {
                    context.main('testConfiguration');
                    context.mainView.on('rendered', renderView);
                } else {
                    context.mainView.updateMenu('testConfiguration');
                    renderView();
                }
            }
        ...
        questionBankForm: function (id) {
            ...
            function registration(context) {
                var startTime = new Date();
                var contentViewUrl = 'views/VQuestionBank/CreateView';
                var topBarViewUrl = 'views/VQuestionBank/CreateTopBarView';
                var self = context;
                ...
                if (context.mainView === null) {
                    context.main('VQuestionBank');
                    context.mainView.on('rendered', renderView);
                } else {
                    context.mainView.updateMenu('VQuestionBank');
                    renderView();
                }
            }
            registration(self);
        ...
        examStudentsResult: function (id) {
            var self = this;
            var currentUser = App.currentUser || {};
            ...
            function editSutdentExamResult(context) {
                var contentViewUrl = 'views/VExamSchedule/studentResults/EditView';
                var collectionUrl = context.buildCollectionRoute('VExamStudentsResult');
                var self = context;

                function renderView() {
                    return require([contentViewUrl, collectionUrl], function (ContentView, Collection) {
                        var collection = new Collection({id: id ,reset: true});
                ...
                if (context.mainView === null) {
                    context.main('VExamStudentResult');
                    context.mainView.on('rendered', renderView);
                } else {
                    context.mainView.updateMenu('VExamStudentResult');
                    renderView();
                }
            }
        ...
        examResultForm: function (id) {
            ...
            function editExamResult(context) {
                var contentViewUrl = 'views/VExamSchedule/result/EditView';
                var self = context;
                ...
                function renderView() {
                    return require([contentViewUrl], function (ContentView) {
                        ...
                        function createViews() {
                            var contentView = new ContentView({modelId: id});
                ...
                if (context.mainView === null) {
                    context.main('VExamResult');
                    context.mainView.on('rendered', renderView);
                } else {
                    context.mainView.updateMenu('VExamResult');
                    renderView();
                }
            }
        ...
        goToCenterSettings: function () {
            ...
            tracker.track({
                date: new Date(),
                eventType: 'userFlow',
                name: 'Ceneter Settings',
                message: 'centerSettings',
                email: currentUser.email,
                login: currentUser.login,
                mobilePhone: currentUser.mobilePhone
            });
            ...
            function goWarehouse(context) {
                var startTime = new Date();
                var contentViewUrl = 'views/VCenter/ContentView';
                var topBarViewUrl = 'views/VCenter/TopBarView';
                var self = context;
                ...
                if (context.mainView === null) {
                    context.main('centerSettings');
                    context.mainView.on('rendered', renderView);
                } else {
                    context.mainView.updateMenu('centerSettings');
                    renderView();
                }
        ...
        goToDateList: function (contentType, PageNo, countPerPage, filter) {
            var self = this;
            ...
            function renderDateList() {
                ...
                var collectionUrl = 'collections/'+ contentType +'/dateCollection';
            ...
            function goKanban(context) {
                ...
                function renderView() {
                    return require([contentViewUrl, topBarViewUrl, collectionUrl], function (contentView, topBarView, workflowsCollection) {
                        ...
                        var url = 'erp/' + contentType + '/kanban';
                ...
                function renderView() {
                    return require([contentViewUrl, topBarViewUrl, collectionUrl], function (contentView, topBarView, contentCollection) {
                        ...
                        function createViews() {
                            ...
                            collection.unbind('reset');
                            // var url = '#erp/' + contentType + '/thumbnails';
                            eventsBinder.subscribeCollectionEvents(collection, contentview);
                            eventsBinder.subscribeTopBarEvents(topbarView, contentview);
        ...
        getList: function (contentType) {
            ...
            Backbone.history.navigate('#erp/' + contentType + '/' + viewType, {trigger: true, replace: true});
        },
        ...
        goToVCourses: function () {
            ...
            function goCourse(context) {
                var startTime = new Date();
                var contentViewUrl = 'views/VCSTManagement/cvmDetails/ContentView';
                var topBarViewUrl = 'views/settingsOverview/TopBarView';
                var self = context;
                ...
                if (context.mainView === null) {
                    context.main('VCourses');
                    context.mainView.on('rendered', renderView);
                } else {
                    context.mainView.updateMenu('VCourses');
                    renderView();
                }
        ...
        goToVExam : function(paper){
            ...
            function goExam(context) {
                var startTime = new Date();
                var contentViewUrl = 'views/VExam/exam/ContentView';
                var topBarViewUrl = 'views/settingsOverview/TopBarView';
                var self = context;
                ...
                function renderView() {
                    return require([contentViewUrl, topBarViewUrl], function (ContentView, TopBarView) {
                        ...
                        contentView = new ContentView({startTime: startTime, paper: paper});
                        topBarView = new TopBarView({actionType: 'Content', hide: true});
                ...
                if (context.mainView === null) {
                    ...
                    context.mainView.updateMenu('VExam');
                    renderView();
                }
        ...
        goToVBatches: function (schedule) {
            var self = this;
            var currentUser = App.currentUser || {};
            ...
            function goCourse(context) {
                var startTime = new Date();
                var contentViewUrl = 'views/VBatchesManagement/batchDetails/ContentView';
                var topBarViewUrl = 'views/settingsOverview/TopBarView';
                var self = context;
                ...
                function renderView() {
                    return require([contentViewUrl, topBarViewUrl], function (ContentView, TopBarView) {
                        ...
                        contentView = new ContentView({startTime: startTime, schedule: schedule});
                        topBarView = new TopBarView({actionType: 'Content', hide: true});
                ...
                if (context.mainView === null) {
                    context.main('VBatches');
                    context.mainView.on('rendered', renderView);
                } else {
                    context.mainView.updateMenu('VBatches');
                    renderView();
                }
        ...
        goToVNotifications: function () {
            ...
            tracker.track({
                date: new Date(),
                eventType: 'userFlow',
                name: 'VNotification Settings',
                message: 'VNotifications',
                email: currentUser.email,
                login: currentUser.login,
                mobilePhone: currentUser.mobilePhone
            });
            ...
            function goCourse(context) {
                var startTime = new Date();
                var contentViewUrl = 'views/VNotifications/details/ContentView';
                var topBarViewUrl = 'views/settingsOverview/TopBarView';
                var self = context;
                ...
                if (context.mainView === null) {
                    context.main('VNotifications');
                    context.mainView.on('rendered', renderView);
                } else {
                    context.mainView.updateMenu('VNotifications');
                    renderView();
                }
