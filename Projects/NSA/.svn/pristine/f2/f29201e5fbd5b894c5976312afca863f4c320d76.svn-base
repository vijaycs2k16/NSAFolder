define([
    ...
    var View = Backbone.View.extend({
        ...
        render: function () {
            ...
            var showFilter = this.options.restoreOptions ? this.options.restoreOptions.showFilter : true
            ...
            var filter = this.options.restoreOptions ? this.options.restoreOptions.filter : 'customDashboardCharts'
