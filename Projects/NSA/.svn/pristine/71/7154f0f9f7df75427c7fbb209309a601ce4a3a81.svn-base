define([
    ...
    'Underscore',
    'jQuery',
    'text!templates/VNotifications/details/students/ListTemplate.html',
    'views/VNotifications/details/students/EditView',
    'views/VNotifications/details/students/CreateView',
    'helpers',
    'helpers/ga',
    ...
    'vconstants',
    'dataService'
], function (Backbone, _, $, PaymentMethodList, EditView, CreateView, helpers, ga, GA, common, Constants, dataService) {
    'use strict';
    ...
    var ContentView = Backbone.View.extend({
        ...
        render: function () {
            var self = this;
            dataService.getData('/permission', {moduleId: Constants.MID.VNotifyStudents}, function (data) {
