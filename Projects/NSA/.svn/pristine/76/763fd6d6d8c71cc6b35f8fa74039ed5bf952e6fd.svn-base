...
require.config({
    ...
    paths: {
        ...
        xlsx         : './../../bower_components/js-xlsx/xlsx',
        blobjs         : './../../bower_components/blobjs/Blob',
        'file-saverjs'   : './../../bower_components/file-saverjs/FileSaver.min',
    ...
    shim: {
        ...
        app: ['Backbone', 'jqueryui', 'ajaxForm', 'imageCrop', 'd3', 'backstratch', 'topojson', 'wickedpicker', 'malihuScrollBar', 'bxSlider', 'dragtable', 'gapi', 'TableExport' /*'inbound_rocket'*/]
    }
});
