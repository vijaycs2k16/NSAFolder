...
(function () {
    ...
    var TIPS = {
        ...
        organizationSettings: {
            name     : 'This name will be shown on all documents in erp',
        ...
        currency: {
            ...
            decPlaces     : 'The number of decimals that will be used in erp',
            active        : 'Check this checkbox is you want to show this currency in erp'
        },
        ...
        priceList: {
            priceListName: 'This name will be shown in erp documents',
            priceListCode: 'This price list code will not be shown in erp documents',
        ...
        shippingMethods: {
            name   : 'This shipping name will be shown in erp documents',
        ...
        integrations: {
            channelName   : 'This channel name will be shown in erp',
            apishop       : 'Shop name as it is shown on ETSY platform',
            apiuser       : 'API keystring used for connection app on ETSY with erp',
            apipassword   : 'API shared secret string for connection app on ETSY with erp',
            warehouse     : 'Warehouse that will be used for synchronizing the products between erp and this ETSY store',
            ...
            shippingStatus: 'Check this checkbox if you want to update the shipping status from erp to ETSY',
            shippingMethod: 'Check this checkbox if you wan to update shipping method from erp to ETSY'
        },
        ...
        Profiles: {
            profileName       : 'This profile name will be shown in erp.',
        ...
        Departments: {
            departmentName   : 'This department name will be used and shown in erp.',
        ...
        Others: {
             phoneNo: 'Enter valid mobile numbers with comma separated'
        },
        ExamConfiguration: {
            examDuration: 'Exam duration before the start time and end time'
        }
    };
