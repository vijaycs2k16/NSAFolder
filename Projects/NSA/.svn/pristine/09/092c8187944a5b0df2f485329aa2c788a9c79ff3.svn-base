define([
    ...
    'text!templates/VCourses/list/cancelEdit.html',
    'text!templates/VCourses/list/ListHeader.html',
    'text!templates/VCourses/list/ListTemplate.html',
    'views/VCourses/list/ListItemView',
    'views/VCourses/CreateView',
    'models/JournalModel',
    'collections/VCourses/filterCollection',
    'collections/VCourses/editCollection',
    'dataService',
    'async'
