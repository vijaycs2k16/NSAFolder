...
module.exports = function (models) {
    ...
    router.get('/Users', handler.getUserFilters);
    router.get('/EnrollMent', handler.getEnrollmentFilters);
    router.get('/BundleMove', handler.getBundleMoveFilters);
    router.get('/BundleReturns', handler.getBundleReturnsFilters);
    router.get('/VPracticeExam',handler.getPracticeExamFilters);
    router.get('/VExamSchedule', handler.getExamScheduleFilters);
    router.get('/VExamStudentsResult', handler.getExamStudentResultFilters);
    ...
    router.get('/VStudentLeads', handler.getLeadsFilters);
    router.get('/VStudent', handler.getStudentFilters);
    router.get('/VQuestionBank', handler.getQuestionFilters);
    ...
    router.get('/stockReturns', handler.getStockReturnsFilters);

    router.get('/stockCorrections',handler.getStockCorrectionFilters);
