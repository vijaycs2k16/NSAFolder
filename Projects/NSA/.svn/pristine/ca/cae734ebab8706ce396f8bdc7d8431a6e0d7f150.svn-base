define([
    ...
    'text!templates/VFranchise/list/cancelEdit.html',
    'text!templates/VFranchise/list/ListHeader.html',
    'text!templates/VFranchise/list/ListTemplate.html',
    'views/VFranchise/list/ListItemView',
    'views/VFranchise/CreateView',
    'models/JournalModel',
    'collections/VFranchise/filterCollection',
    'collections/VFranchise/editCollection',
    'dataService',
    'async'
