...
HTTP/1.1 200 OK
{
      ...
      "data": [
        ...
        ...
                 ...
                 */
    router.put('/current/:id',  handler.putchModel);
    ...
    router.get('/details', authStackMiddleware, handler.getUserDetails);
    ...
    router.put('/:id', authStackMiddleware, handler.putchModel);
