...
public interface Constants {
    ...
    String ID = "id";
    String ACCESS_ID = "ac8989d0-557c-11e7-a9da-618c0b66b59e";
    String BHASHYAM_ACCESS_ID = "85834430-5d87-11e7-8234-4be92e1eb721";
    Double LATITUDE = 11.021617;
    Double LONGITUDE =  75.910614;
    String SCHOOL_NAME = "Madrasathul Anwar Higher Secondary School";
    ...
    String BASE_URL = "https://app.nexschoolapp.com";
    ...
    String SERVER_APIKEY = "AAAAnP9JhCM:APA91bFu3DSctTrnwCkYkVxe72BTMTZQQztbO2alRkC-ww663kjZmpvo8ZJEyy5x2rKuQqSizHBaqG4sPr7HTe23WT-SrVzGj7VLuEKaIF9yo45IgR7AfAXHXwkhb2amkwyhTGp02OLU";
