...
public class ClassesTest extends Browser {
	...
	@Test
	public void classes() throws ParserConfigurationException, SAXException,
		...
		Common.clickPos(driver, loginproperties, "navigate_Classes");
		Thread.sleep(2000);
		Common.clickPos(driver, loginproperties, "click_Status");
		Common.clickPos(driver, loginproperties, "confirm");
		Thread.sleep(5000);
	}
