define([
    ...
    'views/PrintView'
], function (Backbone, $, _, FilterView, ConfirmView, aphabeticTemplate, CONSTANTS, FILTERS, common, async, dataService, helpers, custom, ga, GA, PrintView) {
    var View = Backbone.View.extend({
        ...
        checked: function (e) {
            ...
            var $bulkButton = $topBar.find('#bulkBtn');
            var $PdfButton = $topBar.find('#printPdf');
            var download = $topBar.find('#download');
            var errLogBtn = $topBar.find('#errLogBtn');
        ...
        changeLocationHash: function (page, count, filter, options) {
            ...
            var mainLocation = '#erp/' + this.contentType + '/' + this.viewType;
        ...
        exportItem: function () {
            ...
            data = _.compact(data);
            dataService.postData('/vassessment/question?count=20000', {"ids": data}, function (err, dataObj) {
                new self.PrintView({
                    collection: dataObj
                });
        ...
        showSaveCancelBtns: function () {
            ...
            var bulkBtnEl = $topBar.find('#bulkBtn');
            var createBtnEl = $topBar.find('#top-bar-createBtn');
            var printPdfEl = $topBar.find('#printPdf');
