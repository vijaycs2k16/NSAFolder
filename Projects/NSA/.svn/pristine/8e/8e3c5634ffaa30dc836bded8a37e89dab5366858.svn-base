...
/**
 * Created by Karthik on 2/10/15.
 */
public class AndroidTreeView implements Serializable{
    ...
    public ArrayList<TreeNode> getSelected() {
        if (mSelectionModeEnabled) {
    ...
    private ArrayList<TreeNode> getSelected(TreeNode parent) {
