define(
    function () {
        ...
        var checkPhoneField = function (errorArray, required, fieldValue, fieldName) {
            if (required) {
                ...
                if (fieldValue.length != 10 ) {
                    errorArray.push([fieldName, errorMessages.minLengthMsg(10)].join(' '));
                    return;
                }
        ...
        var passEmptyCheck = function (errorArray, password, oldPass, confirmPass) {
            if (_.isEmpty(password) || _.isEmpty(confirmPass) || _.isEmpty(oldPass)) {
                    errorArray.push(errorMessages.requiredMsg);
            }
        };
        ...
        var  OnlyNumber = function (char) {
            return !char.match(numbersOnly);
        };
