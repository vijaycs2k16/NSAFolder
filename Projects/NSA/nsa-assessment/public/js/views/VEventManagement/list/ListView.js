define([
    ...
    'text!templates/VEventManagement/list/cancelEdit.html',
    'text!templates/VEventManagement/list/ListHeader.html',
    'text!templates/VEventManagement/list/ListTemplate.html',
    'views/VEventManagement/list/ListItemView',
    'views/VEventManagement/CreateView',
    'models/JournalModel',
    'collections/VEventManagement/filterCollection',
    'collections/VEventManagement/editCollection',
    'dataService',
    'async'
