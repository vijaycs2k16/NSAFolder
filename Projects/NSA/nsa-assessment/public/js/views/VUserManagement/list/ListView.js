define([
    ...
    'text!templates/VUserManagement/list/cancelEdit.html',
    'text!templates/VUserManagement/list/ListHeader.html',
    'text!templates/VUserManagement/list/ListTemplate.html',
    'views/VUserManagement/list/ListItemView',
    'views/VUserManagement/CreateView',
    'models/JournalModel',
    'collections/VUserManagement/filterCollection',
    'collections/VUserManagement/editCollection',
    'dataService',
    'async'
