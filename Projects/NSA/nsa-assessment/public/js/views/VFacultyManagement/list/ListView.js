define([
    ...
    'text!templates/VFacultyManagement/list/cancelEdit.html',
    'text!templates/VFacultyManagement/list/ListHeader.html',
    'text!templates/VFacultyManagement/list/ListTemplate.html',
    'views/VFacultyManagement/list/ListItemView',
    'views/VFacultyManagement/CreateView',
    'models/JournalModel',
    'collections/VFacultyManagement/filterCollection',
    'collections/VFacultyManagement/editCollection',
    'dataService',
    'async'
    ...
    var ListView = listViewBase.extend({
        ...
        render: function () {
            ...
            dataService.getData('/course/getForDd', {}, function (debitAccount) {
