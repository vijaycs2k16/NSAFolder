            ...
            if (supplier) {
                this.model.save(data, {
                    ...
                    success: function () {
                        ...
                        if (self.mid === 97) {
                            redirectUrl = '#erp/ExpensesPayments/list';
                        } else if (self.mid === 100) {
                            redirectUrl = '#erp/DividendPayments/list';
                        } else if (self.mid === 109) {
                            redirectUrl = '#erp/purchasePayments/list';
                        } else if (self.mid === 95) {
                            redirectUrl = '#erp/purchasePayments/list';
                        } else {
                            redirectUrl = self.forSales ? 'erp/customerPayments' : 'erp/supplierPayments';
                        }
