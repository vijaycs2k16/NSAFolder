define([
    ...
    'text!templates/Opportunities/dateList/ListHeader.html',
    'text!templates/Opportunities/dateList/dateItemTemplate.html',
    'text!templates/Opportunities/dateList/activityTemplate.html',
    'views/pagination',
    'views/Opportunities/CreateView',
    'views/Opportunities/EditView',
    'models/VStudentOppModel',
    ...
    var TasksListView = pagination.extend({
        ...
        formUrl     : '#erp/Opportunities/tform/',
