define([
    ...
    'constants',
    'Lodash'
], function (Backbone, $, _, listViewBase, listTemplate, stagesTamplate, createView, ListItemView, ListTotalView, EditView, OrderModel, contentCollection, common, dataService, helpers, CONSTANTS, lodash) {
    'use strict';
