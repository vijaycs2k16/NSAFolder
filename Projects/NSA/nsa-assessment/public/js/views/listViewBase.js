define([
    ...
    'Lodash'
], function (Backbone, $, _, paginationTemplate, importForm, Pagination, SelectView, AttachView, common, dataService, CONSTANTS, helpers, GUIDES, notifyTemplate, GuideNotify, lodash) {
    'use strict';
    ...
    var ListViewBase = Pagination.extend({
        ...
        events: {
            ...
            'click .list1 td:not(.notForm, .checkbox)'       : 'gotoForm'
        },
        ...
        initialize: function (options) {
            ...
            this.pagination = options.pagination == false ? options.pagination : true ;
