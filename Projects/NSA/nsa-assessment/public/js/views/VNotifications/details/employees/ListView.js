define([
    ...
    'Underscore',
    'jQuery',
    'text!templates/VNotifications/details/employees/ListTemplate.html',
    'views/VNotifications/details/employees/EditView',
    'views/VNotifications/details/employees/CreateView',
    'helpers',
    'helpers/ga',
    ...
    var ContentView = Backbone.View.extend({
        ...
        render: function () {
            var self = this;
            dataService.getData('/permission', {moduleId: constants.MID.VNotifyEmp}, function (data) {
