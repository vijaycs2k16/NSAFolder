define([
    ...
    'Underscore',
    'views/listViewBase',
    'text!templates/VStudent/list/ListHeader.html',
    'views/VStudent/CreateView',
    'views/VStudent/EditView',
    'views/VStudent/list/ListItemView',
    'collections/VStudent/filterCollection',
    ...
    'use strict';
    var StudentListView = ListViewBase.extend({
        ...
        gotoForm: function (e) {
            ...
            model.urlRoot = '/vstudents/detailsById/';
            model.fetch({
                data   : {id: id},
