define([
    ...
    var EditView = DialogViewBase.extend({
        ...
        saveItem: function () {
            ...
            var salary = $.trim($thisEl.find('#salary').val());
            ...
            var center = $thisEl.find('#centerDd').data('id');
            var usersId = [];
            var groupsId = [];
            ...
            this.currentModel.save(data, {
                ...
                success: function () {
                    ...
                    Backbone.history.navigate(location, {trigger: true});return App.render({
                        type: 'notify',
        ...
        render: function () {
            ...
            populate.get('#centerDd', '/franchise/', {}, 'centerName', this, true, true);
