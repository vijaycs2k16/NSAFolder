    ...
    var CreateView = ParentView.extend({
           ...
           /* var otherIncome = thisEl.find('#otherIncome').attr('data-id') || null;
            ...
            this.model.save(data, {
                success: function (model) {
                    ...
                    Backbone.history.navigate('erp/productsSettings', {trigger: true});*/
        ...
        render: function () {
          ...
          //  populate.get('#parentCategory', categoryUrl, {}, 'name', this, true);
            ...
            dataService.getData('/category/', {}, function (categories) {
                self.responseObj['#parentCategory'] = categories.data;
            });
