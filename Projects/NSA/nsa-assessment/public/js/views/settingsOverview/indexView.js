    ...
    var ContentView = Backbone.View.extend({
        ...
        initialize: function (options) {
            ...
            this.views.organizationView = {
                ...
                redirectRef: '#erp/organizationSettings'
            };
            this.views.accountingView = {
                view       : accountingView,
                redirectRef: '#erp/Accounts'
            };

            this.views.productsView = {
                view       : productDetailsView,
                redirectRef: '#erp/productsSettings'
            };

            this.views.employeesView = {
                view       : settingsEmployeeView,
                redirectRef: '#erp/settingsEmployee'
            };

            this.views.usersView = {
                redirectRef: '#erp/Users',
                trigger    : true
            };

            this.views.profilesView = {
                redirectRef: '#erp/Profiles',
                trigger    : true
            };

            this.views.departmentsView = {
                redirectRef: '#erp/Departments',
                trigger    : true
            };

            this.views.workflowsView = {
                redirectRef: '#erp/Workflows',
                trigger    : true
            };

            this.views.integrationsView = {
                redirectRef: '#erp/integrations',
                trigger    : true
            };
