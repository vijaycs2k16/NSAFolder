define([
    ...
    'helpers',
    'constants'
], function (Backbone, $, _, ListViewBase, listTemplate,ListItemView, stockReturnsCollection, CurrentModel, dataService, populate, async, helpers, CONSTANTS) {
    'use strict';
    ...
    var StockReturnsListView = ListViewBase.extend({
        ...
        contentType      : CONSTANTS.STOCKRETURNS, // needs in view.prototype.changeLocationHash
        modelId          : null,
        $listTable       : null,
        editCollection   : null,
