define([
    ...
    'text!templates/VBatches/list/cancelEdit.html',
    'text!templates/VBatches/list/ListHeader.html',
    'text!templates/VBatches/list/ListTemplate.html',
    'views/VBatches/list/ListItemView',
    'views/VBatches/CreateView',
    'models/JournalModel',
    'collections/VBatches/filterCollection',
    'collections/VBatches/editCollection',
    'dataService',
    'async'
