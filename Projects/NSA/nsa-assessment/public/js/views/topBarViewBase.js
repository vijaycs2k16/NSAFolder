define([
    ...
    'dataService',
    'vconstants'
], function (Backbone, $, _, Common, Custom, AttachView, ga, GA, dataService, constant) {
    'use strict';
...
//            'click #top-bar-importBtn'      : 'importEvent',
        ...
        onPrintPdf: function (event) {
            event.preventDefault();
            this.trigger('PrintEvent');
        ...
        render: function (options) {
            ...
            if (!options || !options.hide) {
                var self  = this;
                dataService.getData('/permission', {moduleId: constant.MID[this.contentType]}, function (data) {
