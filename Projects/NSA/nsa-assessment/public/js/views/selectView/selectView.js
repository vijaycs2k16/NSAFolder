define([
    ...
    'collections/Filter/orderCollection',
    'dataService'
], function (Backbone, $, _, selectTemplate, selectContent, FilterCollection, OrderCollection, dataService) {
    var selectView = Backbone.View.extend({
        ...
        createNewElement: function (e) {
            ...
            Backbone.history.navigate('#erp/' + type, {trigger: true});
        },
        ...
        initialize: function (options) {
          ...
          if (!$target || !$target.length){
            ...
            if(this.attr == 'month') {
                this.collection = new OrderCollection(data);
                this.filteredCollection = new OrderCollection(data);
            } else {
