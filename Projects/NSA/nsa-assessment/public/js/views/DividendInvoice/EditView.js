define([
    ...
    var EditView = ParentView.extend({
        ...
        cancelInvoice: function (e) {
            var wId;
            var self = this;
            var redirectUrl = self.forSales ? 'erp/salesInvoices' : 'erp/Invoices';
        ...
        setDraft: function (e) {
            ...
            redirectUrl = self.forSales ? 'erp/salesInvoices' : 'erp/Invoices';
        ...
        deleteItem: function (event) {
            ...
            // var redirectUrl = this.forSales ? url : 'erp/Invoice';
