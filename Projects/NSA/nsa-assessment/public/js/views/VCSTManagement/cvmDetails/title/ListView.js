define([
    ...
    'Underscore',
    'jQuery',
    'text!templates/VCSTManagement/cvmDetails/title/ListTemplate.html',
    'views/VCSTManagement/cvmDetails/title/EditView',
    'views/VCSTManagement/cvmDetails/title/CreateView',
    'helpers',
    'helpers/ga',
    ...
    var ContentView = Backbone.View.extend({
        ...
        render: function () {
            var self = this;
            dataService.getData('/permission/tabs', {module : constant.MID.CSTMangement, moduleId: constant.MID.TitleTab}, function (data) {
                var className =  data.data.tab ? 'active' : '';
                $('#title').addClass(className);
                $('#titleTab').addClass(className)
                if(data.data.read) {
                    $('#title').removeClass('hide')
                    $('#titleTab').removeClass('hide')
                } else {
                    $('#title').addClass('hide')
                    $('#titleTab').addClass('hide')
                }
