define([
    ...
    var CreateView = ParentView.extend({
        ...
        saveItem: function () {
            ...
            dateOfJ = $.trim($thisEl.find('#doj').val());
            dateOfEx = $.trim($thisEl.find('#doe').val()) || null ;
            $jobTable = $thisEl.find('#hireFireTable');
            marital = $thisEl.find('#maritalDd').attr('data-id') || null;
            employmentType = $thisEl.find('#employmentTypeDd').attr('data-id') || "Employees";
            nationality = $thisEl.find('#nationality').attr('data-id') == '' ? null : $thisEl.find('#nationality').attr('data-id');
            ...
            jobPosition = $tr.find('#jobPositionDd').attr('data-id') || null;
            weeklyScheduler = $tr.find('#weeklySchedulerDd').attr('data-id') || null;
            ...
            department = $tr.find('#departmentsDd').attr('data-id') || null;
            jobType = $.trim($tr.find('#jobTypeDd').text()) || null;
        ...
        render: function () {
            ...
            populate.get('#center', '/franchise/', {}, 'centerName', this, true);
