...
;(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        var TableExport = function (selectors, options) {
             ...
             */
            self.selectors = _nodesArray(selectors);console.log("selectors",self.selectors)
