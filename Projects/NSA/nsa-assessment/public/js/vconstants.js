define([], function () {
    return {
        ...
        STAGE_3_TEMPLATE           : 'Stage 3 Template',
        ...
        VBATCHES                   : 'VBatches',
        VSTUDENT                   : 'VStudent',
        VFACULTYMANAGEMENT         : 'VFacultyManagement',
        VATTENDANCE                : 'VAttendance',
        VFRANCHISE                 : 'VFranchise',
        VLEAVE                     : 'VLeave',
        VUSERMANAGEMENT            : 'VUserManagement',
        VEVENTMANAGEMENT           : 'VEventManagement',
        VNOTIFICATIONS             : 'VNotifications',
        VSTUDENTLEADS             : 'VStudentLeads',
        ENROLLMENT                : 'EnrollMent',
        VExamConfig               : 'VExamConfig',
        VEXAMSCHEDULE             : 'VExamSchedule',
        VQUESTIONBANK             : 'VQuestionBank',
        VDASHBOARDREPORTS         : 'VDashboardReports' ,
        VCOURSEREPORTS            : 'VCourseReports',
        VSLEAVEREPORTS            : 'VSLeaveReports',
        VELEAVEREPORTS            : 'VELeaveReports',
        VLEADSREPORTS             : 'VLeadsReports',
        VPRACTICEEXAM             : 'VPracticeExam',
        BUNDLEMOVE                : 'BundleMove',
        FACULTYLOGS               : 'FacultyLogs',
        SCHOOLONBOARD             : 'schoolOnboard',
        SUBJECTTERMTOPICS         : 'subjectTermTopics',
        ...
        STAGES_TYPE: [
            ...
            {id: 102, status: 'Discontinue'},
            {id: 103, status: 'Deactive'}
        ],
        ...
        URLS: {
            ...
            VCOURSE                     : '/title/',
            BATCHES                     : '/vbatch/',
            VBATCHSCHEDULE              : '/vbatchSchedule',
            SUBJECTSCHEDULE             : '/vbatchSchedule',
            OFFLINESCHEDULE             : '/vbatchSchedule',
            VSUBJECT                    : '/vsubject/',
            VSUBJECTTOPICS              : '/vsubject/topics',
           /* VSUBTOPICS                  : '/vsubject/topics/list',*/
            VSUBTOPIC                  : '/subTopics/',
            VTOPIC                      : '/vsubject/topics/list',
            VFRANCHISE                  : '/franchise/',
            VFRANCHISECOURSE            : '/franchise/getForCenter/',
            VSTUDENT                    : '/vstudents/',
            VSTUDENTDETAILS             : '/vstudents/details',
            VSTUDENTBYID                : '/vstudents/detailsById',
            VSTUDENTS_ALPHABET          : '/vstudents/getStudentsAlphabet',
            VSTUDENTLEAVE               : '/vstudents/leave',
            VSLEAVE                     : '/vsleave/',
            VNOTIFICATIONS              : '/vnotifications',
            VEMPNOTIFICATIONS           : '/vnotifications/employee/',
            VOTHERNOTIFICATIONS         : '/vnotifications/other/',
            VENROLLMENT                 :  '/vregister/',
            VENROLLMENTDETAILS          :  '/vregister/details',
            VEXAMCONFIGURATON           : '/vassessment/examconfig',
            VPAPERCONFIGURATION         : '/vassessment/sheet',
            VEXAMSCHEDULE               : '/vassessment/exam',
            VQUESTIONBANK               : '/vassessment/questions/',
            VTRANSACTIONS               : '/vtransactions',
            VTRANSACTIONREPORTS         : '/vtransactions/reports',
            VEXAMSRESULT                : '/vassessment/exam/student/view/',
            VEXAMSTUDENTRESULT          : '/vassessment/exam/details/',
            VPRACTICEEXAMS              : '/vpractice/exam/practice/list',
            BUNDLEMOVE                  : '/products/bundle/list',
            BUNDLERETURNS               : '/products/bundle/list',
            FACULTYLOGS                 : '/facultyLogs/',
            TITLE                       : '/subjectTitle/',
            SCHOOLONBOARD               : '/schoolSubjectTitle/',
            SUBJECTTERMTOPICS           : '/subjectTermTopics/',
            TESTCONFIGURATION           : '/testConfiguration/'
            // NSA Ends
        },
        ...
        MID: {
            ...
            stockTransactions  : 131,
            VNotifications     : 1009,
			VFRANCHISE         : 1003,
            FranchiseTab       : 1034,
            CourseTab          : 1035,
            CSTMangement       : [1051, 1025, 1044, 1050],
            VStudent           : 1011,
            VQuestionBank      : 1015,
            VExamSchedule      : 1017,
            VFRANCHISECOURSE   : 1004,
            VFRANCHISESUBJECTS : 1025,
            VBatchesManagement : [1033,1026, 1046,1047],
            BatchSchedule      : 1026,
			VBatches           : 1005,
            BatchTab           : 1033,
            VFRANCHISETOPICS   : 1027,
            VFRANCHISECOURSES  : 1028,
            VFRANCHISEDETAILS  : [1034,1028],
            VNotifyEmp         : 1030,
            VNotifyOthers      : 1031,
            VExam              : 1029,
            ExamSetting        : 1016,
            ...
            VSubjectTopics     : 1044,
            FacultyLogs        : 1045,
            SubjectSchedule    : 1046,
            OfflineSchedule    : 1047,
            VSubTopics         : 1050,
            TitleTab           : 1051,
            schoolOnboard      : 1052,
            subjectTermTopics  : 1053,
            testConfiguration  : 1021
