...
module.exports = function (app, mainDb) {
    ...
    var elasticsearch = require('./../services/es/es.config');
   ...
   /* var manufacturingOrderRouter = require('./manufacturingOrder')(models, event);
    ...
    var permisionRouter = require('./permission')(event, models, mainDb);
   ...
   /* var tasksRouter = require('./tasks')(models, event);
    ...
    var orderFormRouter = require('./orderForm')(models, event);
    var specimenRequestRouter = require('./specimenRequest')(models, event);
    var specimenRouter = require('./specimenOrders')(models, event);
    ...
    var subTopicsRouter = require('./SubTopics')(event, models);
   ...
   // var MagentoConnector = require('../helpers/magentoConnector.js');
    ...
    // nsa Start
    var titleRouter = require('./title')(models, event);
    var searchRouter = require('./search')(event);
    var subjectTitleRouter = require('./subjectTitle')(models, event);
    var schoolSubjectTitleRouter = require('./schoolSubjectTitle')(models, event);
    var nsaclassRouter = require('./nsaclass')(models, event);
    var vsectionRouter = require('./vSection')(models, event);
    //var taxonomyRouter = require('./taxonomy')(models, event);
    var studyMaterialRouter = require('./vStudyContent')(models, event);
    var batchRouter = require('./vBatch')(models, event);
    var batchScheculeRouter = require('./vBatchScheduler')(models, event);
    var studentRouter = require('./vStudent')(models, event);
    var studentLeaveRouter = require('./vStudentLeave')(models, event);
    var franchiseRouter = require('./vFranchise')(models, event);
    var franCourseRouter = require('./vFranCourse')(models, event);
    var notificationsRouter = require('./vNotifications')(models, event);

    var subjectRouter = require('./vSubject')(models, event);
    var topicRouter = require('./vTopic')(models, event);

    var assessmentRouter = require('./vAssessment')(models, event);
    var practiceRouter = require('./vPractice')(models, event);
    var transactionRouter = require('./vTransactions')(models, event);
    var feedbackRouter = require('./vFeedback')(models, event);
    var subjectTermTopicsRouter = require('./subjectTermTopics')(models, event);
    var testRouter = require('./testConfiguration')(models, event);
    // NSA Ends
...
//    syncHelper = require('../helpers/sync')(rm, models, event);
   ...
   /* app.use('/nationality', nationalityRouter);
    ...
    app.use('/vStudentLeads', leadsRouter);
    ...
    app.use('/specimenRequest', specimenRequestRouter);
    app.use('/specimenOrders', specimenRouter);
    ...
    app.use('/subjectTitle', subjectTitleRouter);
    app.use('/schoolSubjectTitle', schoolSubjectTitleRouter);
    app.use('/nsaclass', nsaclassRouter);
    app.use('/vsection', vsectionRouter);
    app.use('/vbatch', batchRouter);
    app.use('/vbatchSchedule', batchScheculeRouter);
    app.use('/vsubject', subjectRouter)
    app.use('/vtopic', topicRouter)
    app.use('/franchise', franchiseRouter);
    app.use('/fcourse', franCourseRouter);
    app.use('/vstudents', studentRouter);
    app.use('/vsleave', studentLeaveRouter);
    app.use('/vnotifications', notificationsRouter);
    app.use('/vassessment', assessmentRouter);
    app.use('/vpractice', practiceRouter);
    app.use('/vtransactions', transactionRouter);
    app.use('/vfeedback', feedbackRouter);
    app.use('/vstudymaterials', studyMaterialRouter);
    app.use('/subjectTermTopics', subjectTermTopicsRouter);
    app.use('/testConfiguration', testRouter);
    //nsa ends
    ...
    app.get('/logout/mobile', function (req, res, next) {
        var session = req.session;
        if (session) {
            session.destroy(function (err) {
                if (err) {
