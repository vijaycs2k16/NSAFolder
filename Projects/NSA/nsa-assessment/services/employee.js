...
module.exports = function (models) {
    return new function () {
        this.create = function (options, callback) {
            ...
            options.workEmail = options.workEmail ? (options.workEmail).toLowerCase() : null;
            options.personalEmail = options.personalEmail ? (options.personalEmail).toLowerCase() : null;
        ...
        this.bulkUpdateById = function (query, updateObj, options, callback) {
           var EmployeeModel = models.get(options.dbName, 'Employees', employeeSchema);
           EmployeeModel.update(query, updateObj, {multi: true}, function (err, response) {
                if(err) {
                    callback(err);
                }
