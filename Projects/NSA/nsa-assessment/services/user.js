...
module.exports = function (models) {
    return new function () {
        this.create = function (options, callback) {
            ...
            options.originalPassword = options.pass;
            options.pass = shaSum.digest('hex');
            console.log('dbName', dbName)
            console.log('dbName', models)
        ...
        this.bulkRemoveById = function (query, options, callback) {
            var UserModel = models.get(options.dbName, 'Users', userSchema);
            UserModel.remove(query, function (err, response) {
                if(err) {
                    callback(err);
                }
                callback(null, 'Removed Sucessfully');
            });
        };
