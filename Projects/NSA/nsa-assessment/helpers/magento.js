...
module.exports = function (models, event) {
    ...
    function getSalesOrders(opts, allCallback) {
        ...
        //fullRoute = 'http://magento-test.erp.com/rest/V1/orders?searchCriteria[filter_groups][0][filters][0][field]=entity_id& searchCriteria[filter_groups][0][filters][0][value]=1&searchCriteria[filter_groups][0][filters][0][condition_type]=eq'
    ...
    function getInvoices(opts, allCallback) {
        ...
        fullRoute = baseUrl + route;
        //fullRoute = 'http://magento-erp.test.thinkmobiles.com/rest/V1/invoices?searchCriteria[filter_groups][0][filters][0][field]=order_id& searchCriteria[filter_groups][0][filters][0][value]=145& searchCriteria[filter_groups][0][filters][0][condition_type]=eq';
