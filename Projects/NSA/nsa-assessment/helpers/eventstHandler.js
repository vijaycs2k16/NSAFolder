        ...
        OrderRows.find({
            ...
            .exec(function (err, docs) {
                ...
                getAvailableForRows(req, docs, function (err, status) {
                    ...
                    var serviceProducts = ['5a8035406029abc2ae19d694','5a8035406029abc2ae19d695','5a8035406029abc2ae19d696', '5a8035406029abc2ae19d697']
                    if(docs && docs.length && status.shipped !== 'NOT') {
                       var productObj =  _.filter(docs, function(o) {  if(o.product) { return o.product._id == serviceProducts[0];} });
                       if(!_.isEmpty(productObj)) {
                           updateObj = {status: { fulfillStatus: 'ALL',shippingStatus: 'ALL', allocateStatus: 'ALL' }}
                       }
                    }
